...
public interface I
{
  public static final int CLASS_VERSION=90;
  //public static final boolean DEBUG=false;
  //[local]
  public static final String LOCAL_SYSTEM="service";
  public static final String LOCAL_NAME="<skyDrakkar>";
  public static final String LOCAL_VERSION="3.0 dragonFire";//compiled version
  ...
  //[length && size]
  public static final int LENGTH_LOG_VALUE=256;
